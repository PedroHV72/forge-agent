...
function update(input = {}, dependencies = {}) {
  ...
  if (preview) return { ...plan, applied: false, installer: installed, retirements };
  return { ...plan, applied: true, changed: installed.changed, backup: installed.backup, installer: installed, retirements };
}
