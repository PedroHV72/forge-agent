...
try {
  ...
  assert.strictEqual(validateCodeDirBoundary({ workspaceRoot: workspace, codeDir: path.join(workspace, '..', 'outside'), declaredCodeDir: outside, repoRoots: [outside] }).reason_code, 'code-dir-outside-workspace');
  ...
  try {
    ...
    assert.strictEqual(validateCodeDirBoundary({ workspaceRoot: workspace, codeDir: linkedOutside, declaredCodeDir: linkedOutside, repoRoots: [linkedOutside] }).reason_code, 'code-dir-outside-workspace');
  } catch (error) {
